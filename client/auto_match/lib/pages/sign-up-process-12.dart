...
class sign_up_process_12 extends StatefulWidget {
  @override
  State<sign_up_process_12> createState() => _sign_up_process_12State();
}

class _sign_up_process_12State extends State<sign_up_process_12> {
  ...
  Future<void> fetchImageData() async {
    ...
    final response = await http.get(Uri.parse('$url/pics/dynmaic_catalog/1'));
    print('page!!');
  ...
  void sendDataToServer() async {
    ...
    Navigator.pushNamed(context, '/signup13');
  }
