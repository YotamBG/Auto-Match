...
class sign_up_process_13 extends StatefulWidget {
  @override
  State<sign_up_process_13> createState() => _sign_up_process_13State();
}

class _sign_up_process_13State extends State<sign_up_process_13> {
  ...
  Future<void> fetchImageData() async {
    ...
    final response = await http.get(Uri.parse('$url/pics/dynmaic_catalog/2'));
    print('page!!');
  ...
  void sendDataToServer() async {
    ...
    Navigator.pushNamed(context, '/signup14');
  }
