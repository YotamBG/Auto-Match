...
class sign_up_process_14 extends StatefulWidget {
  @override
  State<sign_up_process_14> createState() => _sign_up_process_14State();
}

class _sign_up_process_14State extends State<sign_up_process_14> {
  ...
  Future<void> fetchImageData() async {
    ...
    final response = await http.get(Uri.parse('$url/pics/dynmaic_catalog/3'));
    print('page!!');
  ...
  void sendDataToServer() async {
    ...
    final trainFaceResponse = await api.dio.post(
      'http://10.0.2.2:5000/dynamic_submitFaces',
    ...
    final dynamicTrainFaceResponse = await api.dio.post(
      'http://10.0.2.2:5000/dynamic_train_face',
      options: Options(headers: {"Content-Type": "application/json"}),
      data: jsonEncode(jsonData),
    );

    final dynamicTrainFaceReqResponse = dynamicTrainFaceResponse.data.toString();
    print('Server Response: ${trainFaceReqResponse}');
