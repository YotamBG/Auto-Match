...
class Training_centre_faces extends StatefulWidget {
  const Training_centre_faces({super.key});

  @override
  State<Training_centre_faces> createState() => _Training_centre_facesState();
}

class _Training_centre_facesState extends State<Training_centre_faces> {
  ...
  Future<void> submitFace() async {
    ...
    Navigator.pushNamed(context, '/training_centre_memo',
        arguments: {'memoNum': 6});
    // Navigator.pushNamed(context, '/training_centre_face_training',
