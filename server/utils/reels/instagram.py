...
def fetch_reels(USERNAME, PASSWORD):
    try:
        # Replace 'your_username' and 'your_password' with your Instagram credentials
        # USERNAME = 'gagamaster701'
        # PASSWORD = 'gagamaster70111'
        ...
        # api.logout()
        print(liked_reels_data)
        return liked_reels_data

    except Exception as e:
        print('error while fetching reels!')
        print(e)
        return jsonify({'error while fetching reels: ': str(e)}), 500
